    ...
    <div>
      <div className="text-left w-full mt-5">
        <p className="text-[var(--text-c)]">
          Enter your email here. During the verification phase, you will receive
          an OTP code for this email
        </p>
      </div>
        ...
        <div className="w-full mb-5">
          ...
          <div className="flex flex-row gap-x-10">
            <Dragger {...uploadprops}>
              ...
              <p className="ant-upload-hint">Front Side Of Your ID.</p>
            </Dragger>
            <Dragger {...uploadprops}>
              <p className="ant-upload-drag-icon">
                <InboxOutlined />
              ...
              <p className="ant-upload-hint">Back Side Of Your ID.</p>
            </Dragger>
          </div>
        </div>
      </div>
