            ...
            <form onSubmit={(e) => e.preventDefault()}>
                <div className='text-left w-[100%] mt-5 flex flex-row flex-wrap gap-x-[20%] gap-y-4'>
                    <div className='w-[40%] mb-0'>
                        ...
                        <p className="ml-2 text-xs text-red-500 w-full italic" >{validationErrors.fname}</p>
                        <input
                            type="text"
                            name="fname"
                    ...
                    <div className='w-[40%] mb-0'>
                        ...
                        <p className="ml-2 text-xs text-red-500 w-full italic" >{validationErrors.lname}</p>
                        <input
                            type="text"
                            name="lname"
                            className='border-2 w-full h-12 rounded-[25px] p-2 focus:outline-[var(--accent)]'
                    ...
                    <div className='w-[40%] mb-0'>
                        ...
                        <p className="ml-2 text-xs text-red-500 w-full italic" >{validationErrors.dob}</p>
                        <input
                            type="date"
                            name="dob"
                            className='border-2 w-full h-12 rounded-[25px] p-2 focus:outline-[var(--accent)]'
