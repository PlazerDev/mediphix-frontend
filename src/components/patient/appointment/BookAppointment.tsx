...
const BookAppointment = () => {
  ...
  />
    ...
    <div className="flex gap-4 mb-1">
              <div>
                <p className="text-black text-l font-bold">Details of the Appointment</p>  
            ...
            <div>
                <p className="text-black text-l font-bold mt-3">Additional Details</p>
            </div>
            <div>
               <p className="text-[#868686] text-sm mt-3">Special Note From Doctor</p>
               <p className=''>N/A</p>
            </div>
            <div>
               <p className="text-[#868686] text-sm mt-3">Special Note From Medical Center</p>
               <p className=''>Please arrive at least 15 minutes before your scheduled appointment time for payment.</p>
            </div>
            </div>
            <div>
            <TimeslotCard/>
            ...
            <p>By proceeding with the appointment booking, you agree to our terms and conditions. Please review the terms carefully before continuing.</p>
            <Checkbox onChange={onChange}>I have read and agree to the  <a style={{ color: 'orange' }}><u>Terms and Conditions.</u></a>
            </Checkbox>
            <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '10px' }}>
           <Button type="primary" style={{ backgroundColor: 'grey', borderColor: 'grey' ,height:'40px'}}>Cancel</Button>
           <Button type="primary" style={{ backgroundColor: 'orange', borderColor: 'orange',width: '200px', height:'40px' }}>Book the Appointment</Button>
