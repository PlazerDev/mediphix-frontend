      ...
      <div className="bg-[#DCDCDC] w-full rounded-[16px]">
        ...
        <div>
          <div className="text-[#363636]">
            <p className="text-base font-semibold ml-4 mt-6 mb-3">Doctor Details</p>
          </div>
          ...
          <div>
            <div className="flex justify">
              ...
              <div className="mr-20">
                ...
                <p className="mb-1 text-[#FF7300] underline">Dr. Nishantha Perera</p>
          ...
          <div className="ml-4">
          <div className="text-[#363636]">
            <p className="text-base font-semibold mt-6 mb-2">Additional Details</p>
          </div>
          ...
          <div className="ml-4">
          <div className="text-[#363636]">
            <p className="text-[#868686] text-sm mt-4">Special Note From Medical Center</p>
          </div>
          <p>Please arrive at least 15 minutes before your scheduled appointment time for payment.</p>
          </div>
        </div>
      </div>
    </>
