                ...
                <div>
                    <Segmented<string>
                        ...
                        options={[
                            ...
                            {label: buttonNames[0], value: buttonNames[0], icon: buttonImages[0]},
                            {label: buttonNames[1], value: buttonNames[1], icon: buttonImages[1]},
                            {label: buttonNames[2], value: buttonNames[2], icon: buttonImages[2]},
                        ]}
                    />
